...
function toFirstFork(start, callback) {
  ...
  // TODO(rmg): we could also limit this later by checking if we've already
  //            listed all of the repository's branches
  git.gitRevList('--children -n 30 ' + start, function(err, revs) {
    var foundFork = false
